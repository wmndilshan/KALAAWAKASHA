...
const DEV_SECRET = import.meta.env.VITE_VERIFY_CODE_DEV_SECRET ?? "dev-only-change-this-secret";
...
export function parseStudentId(studentIdFull: string): ParsedStudentId {
  ...
  if (facultyCode === "A" || facultyCode === "AR") {
    ...
    throw new Error("Invalid A/AR student ID format");
  }
